            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                  <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold">Welcome back, <?php echo $this->session->userdata('loggedUser_KeepAdding')['user_fullname']; ?></h3>
  ...
  <script>
    document.onreadystatechange = function () {
      ...
      if (state == 'interactive') {
          document.getElementById('container-scroller').style.visibility="hidden";
      } else if (state == 'complete') {
          setTimeout(function(){
            document.getElementById('interactive');
            document.getElementById('load').style.visibility="hidden";
            document.getElementById('container-scroller').style.visibility="visible";
          },1000);
      }
    }
  </script>
