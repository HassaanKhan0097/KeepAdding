...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <?php if($user_role == 2){ include_once('contractor/sidebar.php'); }else{ include_once('sidebar.php'); }?>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="table-responsive">
                        <table id="tbl_transaction" class="display expandable-table" style="width:100%">
                          <thead>
                            <tr>
                              <th>ID</th>
                              <th>Amount</th>
